---
name: new
description: Start new feature or fix work with full project context, implementing it correctly the first time. Use when the user explicitly asks to build or implement something or runs /new (also how a backlog item is pulled into action).
---
...
**What the user wants:** Use the request the user gave when invoking this skill. If nothing was provided, ask what to build.
