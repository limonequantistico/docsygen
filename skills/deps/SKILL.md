---
name: deps
description: Update dependencies to latest stable versions and align tech-stack.md. Use only when the user explicitly asks to bump or update dependencies or runs /deps.
---
