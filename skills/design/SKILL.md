---
name: design
description: Create the project's design system (visual tokens and decisions) in .docs/design-system.md. Use only when the user explicitly asks to define the design system or runs /design.
---
...
**Logging:** On success, append to `.docs/changelog.md` per `.docs/changelog-spec.md`: `- YYYY-MM-DD HH:mm ran /design — [brief description of the design direction chosen]`.
