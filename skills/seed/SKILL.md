---
name: seed
description: Transform raw notes in .docs/idea.md into a structured seed document. Use only when the user explicitly asks to create the seed or runs /seed.
---
