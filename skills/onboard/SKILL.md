---
name: onboard
description: Produce or refresh onboarding docs and README so another dev can run and contribute. Use only when the user explicitly asks to refresh onboarding docs or runs /onboard.
---
