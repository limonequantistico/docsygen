...
**Logging:** When this command completes successfully, append a dated entry to `.docs/archive.md`: `- YYYY-MM-DD ran /stack — [brief description of what was decided]`. Create the file if it doesn't exist.