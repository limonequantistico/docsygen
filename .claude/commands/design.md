...
**Logging:** When this command completes successfully, append a dated entry to `.docs/changelog.md`: `- YYYY-MM-DD HH:mm ran /design — [brief description of the design direction chosen]`. Create the file if it doesn't exist.
