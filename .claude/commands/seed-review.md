...
**Logging:** When this command completes successfully, append a dated entry to `.docs/archive.md`: `- YYYY-MM-DD ran /seed-review — [recommendation: Proceed/Revise/Rethink]`. Create the file if it doesn't exist.
