...
**Logging:** When this command completes successfully, append a dated entry to `.docs/changelog.md`: `- YYYY-MM-DD ran /prototype — [brief description of what was generated]`. Create the file if it doesn't exist.