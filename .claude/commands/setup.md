...
**Logging:** When this command completes successfully, append a dated entry to `.docs/changelog.md`: `- YYYY-MM-DD ran /setup — [brief description of what was wired up]`. Create the file if it doesn't exist.
