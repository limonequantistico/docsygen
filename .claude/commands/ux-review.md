...
**Logging:** When this command completes successfully, append a dated entry to `.docs/changelog.md`: `- YYYY-MM-DD ran /ux-review — [brief summary of findings]`. Create the file if it doesn't exist.
