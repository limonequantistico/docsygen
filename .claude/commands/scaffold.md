...
**Logging:** When this command completes successfully, append a dated entry to `.docs/changelog.md`: `- YYYY-MM-DD HH:mm ran /scaffold — [brief description of what was created or validated]`. Create the file if it doesn't exist.
