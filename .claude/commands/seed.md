...
**Logging:** When this command completes successfully, append a dated entry to `.docs/archive/archive.md`: `- YYYY-MM-DD ran /seed — [brief description of what was produced or decided]`. Create the file if it doesn't exist.
