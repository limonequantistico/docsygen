...
### 3. Verify
When done, show the user what was done and ask if they're satisfied. If yes, move the item from the backlog to `.docs/changelog.md` with today's date and time.
