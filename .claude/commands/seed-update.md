...
**Logging:** When this command completes successfully, append a dated entry to `.docs/changelog.md`: `- YYYY-MM-DD ran /seed-update — [brief description of what was added or changed]`. Create the file if it doesn't exist.
